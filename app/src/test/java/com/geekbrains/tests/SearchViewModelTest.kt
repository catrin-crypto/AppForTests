...
fun setup(){
  ...
  @Test
  fun coroutine_ReturnValieIsNotNull_test(){
    ...
    @Test
    fun coroutine_ReturnValueError_test(){
        testCoroutineRule.runBlockingTest {
            val observer = Observer<ScreenState>{}
            val liveData = searchViewModel.subscribeToLiveData()
    ...
    companion object {
        ...
        private const val EXCEPTION_TEXT = "Response is null or failed"
    }
}